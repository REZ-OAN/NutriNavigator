...
import { UPDATE_PRODUCT_RESET } from "../../../services/Constants/productActionTypes.js";
import { useNavigate } from "react-router-dom";
const UpdateProduct = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { error, product } = useSelector((state) => state.productR);

    const {
        loading,
        error: updateError,
        isUpdated,
    } = useSelector((state) => state.productDUR);
